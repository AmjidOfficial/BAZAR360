 ...
 * Optional fields are intentionally optional because Firestore is the source
 * of truth and missing user/admin data must never be replaced with invented facts.
 */
