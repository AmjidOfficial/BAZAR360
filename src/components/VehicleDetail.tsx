          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a 
              href={`https://api.whatsapp.com/send?text=${encodeURIComponent(
                `🚗 *${car.title} (${car.year || 'N/A'})*\n\n💰 *Price:* ${renderPrice(car.price)}\n📍 *Location:* ${car.location || car.registrationCity || 'Pakistan'}\n⚙️ *Specs:* ${car.transmission || 'Automatic'} • ${car.fuelType || 'Petrol'} • ${car.engineCC ? `${car.engineCC}cc` : 'N/A'}\n🛣️ *Mileage:* ${car.mileage ? `${Number(car.mileage).toLocaleString()} km` : 'N/A'}\n\n🔗 *View Listing on Bazar360:* ${window.location.href}`
              )}`}
              target="_blank"
