          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <div className="space-y-1">
              ...
              >
                ...
                <option value="Islamabad">Islamabad Registered</option>
                <option value="Lahore">Lahore Registered</option>
                <option value="Karachi">Karachi Registered</option>
                <option value="Peshawar">Peshawar Registered</option>
              </select>
            </div>
