...
export function AutoChoiceLogo({ className = '', showText = true }: LogoProps) {
  // Chain: /auto_choice_logo_1781509565476.png -> /auto_choice_logo_1781509565476.jpg -> Vector Fallback
  const [imgSrc, setImgSrc] = useState('../../public/auto_choice_logo_1781509565476.png');
  const [hasError, setHasError] = useState(false);

  const handleImageError = () => {
    if (imgSrc === '../../public/auto_choice_logo_1781509565476.png') {
      setImgSrc('../../public/auto_choice_logo_1781509565476.jpg');
    } else {
      setHasError(true);
    }
  };
